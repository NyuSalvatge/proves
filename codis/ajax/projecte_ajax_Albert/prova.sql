...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2019 a las 19:52:49
...
INSERT INTO `clientes` (`nom`, `cognom`, `mail`, `id`) VALUES
('Maria', 'Jose', 'mariajo@gmail.com', 1),
('Sora', 'Kairi', 'kh@gmail.com', 2);
...
INSERT INTO `restaurants` (`tipus`) VALUES
('japones'),
('italia'),
('altres');
...
INSERT INTO `usuarios` (`nombre`, `contra`, `id`) VALUES
('Albert', 'miau1234', 1),
('Chiara', 'moguri1234', 2);
